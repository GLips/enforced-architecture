...
export const crossBoundaryAliasFixtures: CheckFixtures = {
  check: "boundary/cross-boundary-alias",
  ...
  obvious: [
    ...
    // cannot see — and the shortest, most innocuous one to write.
    ...
    // what a pattern already got right.
  ...
  legal: [
    ...
    // directory component, so taking "the first path segment" as the boundary
    // reads them as two boundaries and invents a crossing.
