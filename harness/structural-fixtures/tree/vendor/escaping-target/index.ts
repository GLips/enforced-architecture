...
//
// Nothing walks this directory — the tier's walk drops anything reached through
// a symlink, and `vendor/` is under no configured root. It is here to be RESOLVED: the
