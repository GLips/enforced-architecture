...
| [single-component-export](single-component-export.md) | Script | No | Multiple exported React components in one file (compound components via `Object.assign` are fine) |
...
| [hook-count](hook-count.md) | Script | No | Components with 7+ hook calls (doing too much, extract custom hook) |
| [prop-count](prop-count.md) | Script | No | Components with 8+ props (needs decomposition or context) |
