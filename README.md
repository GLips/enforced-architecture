...
A catalog of 69 ready-to-steal enforcement rules for TypeScript codebases. Steal them, or point your coding agent here and have it design the equivalent for your stack.
...
- **69 rules across 11 categories**, each with a header stating what it prevents and an **Adapt** section for repointing it at your directory layout.
